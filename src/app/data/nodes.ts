...
const NODES = [
	...
	{
		name: "Unremembered Tower Floors",
		interactables: ["Waypoint", "Save", "Markers", "Buy Station", "Pink Sphere"],
		monsters: ["Light Marine", "Marine", "Heavy Marine", "Menace", "Minor Rat", "Rat", "Minor Sliver"],
		upgrades: ["Max Health x8"],
		items: ["Cannon Ammo x100", "Rocket Ammo x80", "Railgun Ammo x80", "200 Gold", "200% Health 100% Armor x4", "Green Key"],
	...
	},
	{
		...
		interactables: ["Waypoint", "Save", "Buy Station", "Common Sell Station"],
		items: ["1000% Armor x1", "100% Armor x1", "300 Gold", "Railgun Ammo x100", "Laser Ammo x192", "Rocket Ammo x60"],
		upgrades: [
	...
	},
	{
		...
		items: ["1000% Armor x1"],
		upgrades: ["Nuke Max Ammo x1", "Nuke Velocity x1", "Railgun Fire Rate x2", "Railgun Max Ammo x4"],
		secretTrophy: true,
	},
	{
	...
	},
	{
		...
		upgrades: ["Railgun Max Ammo x12", "Armor Regen x1", "Laser Super Damage x2"],
	...
	},
	{
		...
		upgrades: ["Railgun Max Ammo x1", "Railgun Damage x4", "Rocket Max Ammo x1", "Cannon Max Ammo x1"],
	...
	},
	{
		...
		upgrades: ["Plasma Damage x16", "Laser Max Ammo x1", "RejuvenX x2"],
	...
	},
	{
		...
		monsters: ["Goliath"],
		interactables: ["Buy Station", "Markers"],
		upgrades: ["Rocket Damage", "Rocket Velocity", "Nuke Velocity", "Random Health"],
	},
	{
	...
	},
	{
		...
		upgrades: ["Rocket Radius x4", "Nuke Radius x4"],
		items: ["1000 Gold"],
		trophy: true,
		pinkSphereDestination: {
	...
	},
	{
		...
		interactables: ["Pink Sphere"],
		upgrades: ["RejuvenX x7", "Homing Fire Rate x7", "Nuke Radius x6", "Rocket Radius x7", "Rocket Big Radius Weapon Mod", "Armor Regen x1"],
		notes: "You can reach this treasure by growing using a pink ring inside the Inner Tree",
	},
	{
		name: "Mahogany Treetop Inner Tree",
		items: ["Plasma Ammo", "Cannon Ammo"],
		interactables: ["Common Sell Station", "Buy Station", "Markers", "Save"],
		monsters: [
			"Mothership",
			"Minor Rat",
		...
		upgrades: ["Random Health", "Nuke Radius", "Plasma Velocity", "Rocket Radius", "Cannon Fire Rate", "Nuke Damage", "Nuke Max Ammo", "Nuke Velocity", "Nuke Radius"],
	...
	},
	{
		...
		upgrades: ["Nuke Damage", "Nuke Max Ammo", "Nuke Velocity", "Nuke Radius"],
		items: ["1000 Gold"],
		trophy: true,
	...
	},
	{
		...
		items: ["1000 Gold"],
		upgrades: ["Dark Hole Damage x6", "Dark Hole Max Ammo x6", "Dark Hole Velocity x18", "Homing Velocity x12", "Homing Fire Rate x18", "Laser Max Ammo x1", "Armor Regen x1"],
		trophy: true,
	},
	{
		name: "Pink Library",
	...
	},
	{
		...
		upgrades: ["Nuke Radius x21", "Random Health x7"],
	...
	},
	{
		...
		upgrades: ["EMP Damage x21", "Random Health x7"],
	...
	{
		name: "Topaz Sponge",
		monsters: ["Baby Spider", "Anti Blue Abomination", "Collapsed Archangel"],
	},
	{
		name: "Topaz Treasure",
		items: [
	...
	},
	{
		...
		notes: "You can reach Hell by finding a Pink Ring inside the I3 Library (without passing a Pink Sphere)",
	},
	{
		name: "I2 Fast Gate",
		monsters: ["Collapsed Angel"],
	...
	},
	{
		...
		interactables: ["Save", "Pink Ring"],
		upgrades: [
			["Dark Hole Damage", "Railgun Damage", "Nuke Damage", "Minigun Damage", "Random Health"],
			"Nuke Radius x2",
			"EMP Radius x2",
			"EMP Freeze Time x2",
			"Railgun Max Ammo x1",
	...
	},
	{
		...
		interactables: ["Save"],
		upgrades: ["Nuke Radius x2", "EMP Radius x1", "Railgun Max Ammo x1", "Minigun Fire Rate x1", "Laser Freeze Time x1"],
		items: ["1000 Gold"],
	},
	{
		name: "Violet Shell 0",
	...
	},
	{
		...
		upgrades: ["EMP Radius", "EMP Freeze Time"],
	},
	{
		name: "I3 Entrance",
		interactables: ["Pink Ring", "Markers", "Buy Station"],
		items: [
			"Homing Ammo x600",
			"Cannon Ammo x150",
			"Laser Ammo x128",
	...
	},
	{
		...
		notes: "Also contains a map of the current I3 Giga-Chunk",
	},
	{
		name: "I3 Waypoint Patch",
	...
	},
	{
		...
		monsters: ["Major Beholder", "Troll", "Hobgoblin", "Orc", "Lamprey", "Green Lamprey", "Spider Lord", "Laboratory", "Minor Rat", "Collapsed Archangel", "Lesser Rat"],
	},
	{
	...
	},
	{
		...
		monsters: ["Green Lamprey", "Yellow Lamprey", "Red Lamprey", "Hobgoblin"],
		interactables: ["Pink Ring"],
		upgrades: ["Minigun Velocity"],
	},
	{
		name: "Beta Sponge Town",
		interactables: ["Waypoint", "Out-Only Waypoint", "Respawn", "Save", "Common Sell Station", "Buy Station", "Pink Ring"],
		upgrades: ["Telekinesis", "Minigun Max Ammo x1", "Plasma Hyper Rapid Fire Weapon Mod"],
		items: ["200 Gold", "100% Armor x1", "Nuke Ammo x30", "Minigun Ammo x3000", "Laser Ammo x192", "Railgun Ammo x150", "EMP Ammo x6"],
	},
	{
...
] as const satisfies readonly NodeDataSpecific[];
